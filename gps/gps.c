...
#define nmea_error(...) 	eat_trace(__VA_ARGS__)



u8 gpsCheckSum = 0;
u8 gpsCheckSumX = 0;
u8 gpsGetCheckSumFlag = 0;
u8 GPRMC_gotDataFlag = 0;
u8 GPGGA_gotDataFlag = 0;
u8 GPGSA_gotDataFlag = 0;
u8 GPGSV_gotDataFlag = 0;
u8 msgGpsDataGood = 0;
char msgTerm[80];
...
u32 GPS_cmdCnt[GPS_CMD_COUNT];
u8 GPS_numCmd;
u32 GPS_cmdRecvLength;
...
int nmea_parse_GPGSA(const char *buff, int buff_sz, nmeaGPGSA *pack)
{
    ...
    {
        nmea_error("INFO: GPS-GPGSA parse error!\r\n");
        return 0;
    }
...
int nmea_parse_GPGSV(const char *buff, int buff_sz, nmeaGPGSV *pack)
{
    ...
    {
        nmea_error("INFO: GPS-GPGSV parse error!");
        return 0;
    }
...
int nmea_parse_GPGGA(const char *buff, int buff_sz, nmeaGPGGA *pack)
{
    ...
    {
        nmea_error("INFO: GPS-GPGGA parse error!\r\n");
        return 0;
    }

    if(0 != _nmea_parse_time(&time_buff[0], (int)strlen(&time_buff[0]), &(pack->utc)))
    {
        nmea_error("INFO: GPS-GPGGA time parse error!\r\n");
        return 0;
    }
...
int nmea_parse_GPRMC(const char *buff, int buff_sz, nmeaGPRMC *pack)
{
    ...
    if(nsen != 13 && nsen != 14)
    {
        nmea_error("INFO: GPS-GPRMC parse error!\r\n");
        return 0;
    }

    if(0 != _nmea_parse_time(&time_buff[0], (int)strlen(&time_buff[0]), &(pack->utc)))
    {
        nmea_error("INFO: GPS-GPRMC time parse error!\r\n");
        return 0;
    }
...
int _nmea_parse_time(const char *buff, int buff_sz, nmeaTIME *res)
{
    ...
    case sizeof("hhmmss.sss") - 1:
        ...
        break;
    default:
        nmea_error("INFO: GPS-Parse of time error (format error)!\r\n");
        success = 0;
        break;
    }
